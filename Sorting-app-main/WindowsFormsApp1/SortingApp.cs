                ...
                case SEMISORTED: //Anya
                    {
                        ...
                        int halfOfArray = tempAmountElements / 2;
                        copyTempInt.Sort(0, halfOfArray, null);
                        int tempValue;
                        for (int index = 0; index < halfOfArray; index++)
                        {
                            if (index % 2 == 0)
                            {
                                tempValue = copyTempInt[index];
                                copyTempInt[index] = copyTempInt[index + halfOfArray];
                                copyTempInt[index + halfOfArray] = tempValue;
                            }
                        }
                        break;
                    }
